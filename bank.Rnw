...
\def\titulo{Álbum de Estampas}
\def\autor{William Chavarría Zamora}
\def\director{Docente: José Antonio Medrano García}
\def\entidad{ENTIDAD COLABORADORA:}
\def\fecha{24 de Febrero de 2022}
% ==============================================================================
...
% aqui va la portada
<<portadx, child='secciones/00_portada.Rnw'>>=
...
<<planx, child='secciones/01_planeacion.Rnw'>>=

@

<<algox, child='secciones/02_algoritmo.Rnw'>>=

@

<<desarrollox, child='secciones/03_desarrollo.Rnw'>>=
